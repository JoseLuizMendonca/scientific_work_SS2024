...
\newcommand{\batitle}{Title}

\title{\batitle}
\author{Jose Luiz S. Mendonça \\ Zion Smuts}
\authormail{js-223959@rwu.de \\ <Insert Zion@rwu.de>}
...
\date{\today}
\matnumber{35756 \\ <Insert Zion's Matriculation Number>}
